...
//        foods.add(new Food("Baked Healthy Fitness Broccoli Pie with Basil","BY VIKTOR HANACEK",R.drawable.food5,R.drawable.avatar4));
        photos.add(new Photo("星孩家庭的负重", R.drawable.photo1));
        photos.add(new Photo("绘画的治愈力量", R.drawable.photo2));
        photos.add(new Photo("星儿挑食", R.drawable.photo10));
        photos.add(new Photo("自闭症", R.drawable.photo3));
        photos.add(new Photo("德国人", R.drawable.photo4));
        photos.add(new Photo("德国人", R.drawable.photo5));
        photos.add(new Photo("德国人", R.drawable.photo6));
        photos.add(new Photo("星儿挑食", R.drawable.photo7));
        photos.add(new Photo("星孩家庭的负重", R.drawable.photo8));
        photos.add(new Photo("德国人", R.drawable.photo9));
